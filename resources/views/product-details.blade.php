    ...
    <div id="wrapper">
        ...
        <section class="headings">
            <div class="text-heading">
                <div class="container">
                    <h1 class="text-center">{{ $pro_title->category->product_cat }}</h1>
                </div>
            </div>
        </section>
        <div class="road">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <a href="index.html">Home</a><span>»</span><span>{{ $pro_title->solutions->solution }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="all-services">
            <div class="container">
                <div class="section-title">
                    ...
                    <h2>{{ $pro_title->solutions->solution }}</h2>
                </div>
                <div class="row mt-50">
                    @foreach($pro_details as $pd)
                        <div class="col-lg-4 col-xs-12 col-sm-12 col-md-6">
                            <div class="item mb-30">
                                <div class=service-box>
                                    <figure class="img-box">
                                        <a href="residental-interior.html"><img src="{{ asset('storage/' . $pd->img) }}" alt="" style="height: 260px;"></a>
                                        <figcaption class="default-overlay-outer">
                                            <div class="inner">
                                                <div class="content-layer">
                                                    ...
                                                    <a class="btn btn-secondary mt-5" href="/details/{{ encrypt($pd->id) }}">Details&nbsp;&nbsp;&nbsp;</a>
                                                 </div>
                                            </div>
                                        </figcaption>
                                    </figure>
                                    <div class="clearfix service-inner-box">
                                        <div class=service-content-box>
                                            <h3 style="color: black;font-weight:900">{{ $pd->category->product_cat }}</h3>
                                            <h3 style="color: #601a34;font-weight:500">{{ $pd->all_solution }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
